...
class ContentGenerator {
  ...
  async freeform({ question }) {
    ...
    try {
      ...
      return { result: normalizeFreeformLatex(result) };
    } catch (error) {
      ...
      return { result: normalizeFreeformLatex(draft) };
    }
  }
}
...
module.exports = {
  ...
  QUALITY_INSTRUCTIONS, FREEFORM_AUDIT_INSTRUCTIONS, testQualityIssues, normalizeFreeformLatex, normalizeTestOptionLineBreaks,
