...
- Проверь, что условия однозначны, данных достаточно для решения, а ответы и пояснения не противоречат друг другу.
- Проверь корректность LaTeX, нумерации, Markdown и отсутствие ссылок на несуществующие изображения, графики или таблицы.
